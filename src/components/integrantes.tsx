            ...
            <div className="w-full md:w-1/4 p-2">
              <div className="h-full bg-white px-6 pt-12 pb-20 rounded-lg overflow-hidden text-center relative shadow-sm">
                ...
                <p className="leading-relaxed mb-3">
                  ...
                  tecnologías como React, Node.js y MongoDB. Apasionado por
                  crear soluciones tecnológicas innovadoras que satisfagan las
            ...
            <div className="w-full md:w-1/4 p-2">
              <div className="h-full bg-white px-6 pt-12 pb-20 rounded-lg overflow-hidden text-center relative shadow-sm">
                ...
                <p className="leading-relaxed mb-3">
                  ...
                  como React, Express y MongoDB. Con una sólida comprensión de
                  los principios de diseño de software, trabaja para crear
            ...
            <div className="w-full md:w-1/4 p-2">
              <div className="h-full bg-white px-6 pt-12 pb-20 rounded-lg overflow-hidden text-center relative shadow-sm">
                ...
                <p className="leading-relaxed mb-3">
                  ...
                  comprometido con ofrecer experiencias de usuario excepcionales
                  a través de interfaces intuitivas y funcionales.
                </p>
              </div>
            </div>
            <div className="w-full md:w-1/4 p-2">
              <div className="h-full bg-white px-6 pt-12 pb-20 rounded-lg overflow-hidden text-center relative shadow-sm">
                ...
                <p className="leading-relaxed mb-3">
                  Programador backend con experiencia en el desarrollo de
                  sistemas escalables y seguros. Especializado en tecnologías
                  como Node.js, Python y SQL. Con un enfoque en la eficiencia y
                  la seguridad, trabaja para construir soluciones backend
                  robustas que impulsen el rendimiento y la fiabilidad de las
                  aplicaciones.
                </p>
              </div>
            </div>
