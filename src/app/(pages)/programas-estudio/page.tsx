...
export default function ProgramaEstudio() {
  ...
  const [selectedTechnology, setSelectedTechnology] = useState<Technology>('react'); // Por defecto, establece la tecnología seleccionada en 'react'
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex flex-wrap mb-8 bg-white shadow-lg rounded-lg justify-center max-w-ld mx-auto">
            <Categories setSelectedTechnology={setSelectedTechnology} />
          </div>
        </div>
